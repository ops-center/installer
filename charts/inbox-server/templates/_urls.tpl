...
{{- printf "%s-cassandra.%s.svc:%s," (include "inbox-server.fullname" .) .Release.Namespace "9042" }}
{{- end -}}
...
{{- printf "%s-opensearch.%s.svc:%s," (include "inbox-server.fullname" .) .Release.Namespace "9200" }}
{{- end -}}
