...
|---------------------------------------------------------|----------------------------------------------------------------|---------------------------------------------|
| dns.emailDomain                                         | # Default domain for all emailing components                   | <code>"example.com"</code>                  |
| dns.jmapUrl                                             |                                                                | <code>"jmap.example.com"</code>             |
| dns.adminUrl                                            |                                                                | <code>"admin.example.com"</code>            |
| dns.smtpHostname                                        |                                                                | <code>"smtp.example.com"</code>             |
...
| james.tls.secretName                                    |                                                                | <code>the-name-of-a-secret</code>           |
...
| ingress.annotations.cert-manager.io/cluster-issuer      |                                                                | <code>name-of-the-cluster-issuer</code>     |
| ingress.tls.secretName                                  |                                                                | <code>the-name-of-a-secret</code>           |
| adminIngress.enabled                                    |                                                                | <code>false</code>                          |
| adminIngress.annotations.cert-manager.io/cluster-issuer |                                                                | <code>name-of-the-cluster-issuer</code>     |
| adminIngress.tls.secretName                             |                                                                | <code>the-name-of-a-secret</code>           |
| cassandra.deploy                                        |                                                                | <code>"as-pod"</code>                       |
| cassandra.namespace                                     |                                                                | <code>change-me</code>                      |
| cassandra.replicaCount                                  |                                                                | <code>1</code>                              |
...
| elasticsearch.deploy                                    |                                                                | <code>"as-pod"</code>                       |
| elasticsearch.namespace                                 |                                                                | <code>change-me</code>                      |
| elasticsearch.replicaCount                              |                                                                | <code>1</code>                              |
